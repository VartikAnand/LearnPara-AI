...
interface SubTopicExplanationProps {
  selectedChapter: string | null; // Update the type to string | null
  filtername: string;
}
...
const SubTopicExplanation: React.FC<SubTopicExplanationProps> = ({ selectedChapter, filtername }) => {
  return (
    <div>
      ...
      {selectedChapter !== null ? selectedChapter : 'No chapter selected'} {/* Updated condition to check for null */}
